<?php
class Granguia_Model_Estadistica_ClickAnuncioBarrio extends Core_Model_Abstract{
	...
	public static function Registrar($cantidad, $id_barrio, $nombre_barrio, $dia){
		$e = new self();
		$e
			...
			->setDia($dia)
		;
		$e->setWhere(Db_Helper::equal('dia'), Db_Helper::equal('id_barrio'));
		if($e->searchCount()){
	...
	public function getDbTableName(){
		return 'gg_estadistica_click_barrio';
	}
	//Core_Model_Abstract
}
?>