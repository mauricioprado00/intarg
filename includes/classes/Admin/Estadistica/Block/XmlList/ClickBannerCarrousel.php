<?
class Admin_Estadistica_Block_XmlList_ClickBannerCarrousel extends Jqgrid_Block_XmlList{
	protected function loadData($page, $rows, $sidx, $sord, $comparator){
		$estadistica = new Granguia_Model_Estadistica_ClickBannerCarrousel();
		if($comparator!=null){
