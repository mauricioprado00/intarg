<?
class Admin_Estadistica_Block_XmlList_ClickAnuncioCategoria extends Jqgrid_Block_XmlList{
	protected function loadData($page, $rows, $sidx, $sord, $comparator){
		$estadistica = new Granguia_Model_Estadistica_ClickAnuncioCategoria();
		if($comparator!=null){
